...
const Sidebar = () => {
  ...
  let Option = (params) =>{
    ...
    return(
    <Link href={params.href} className={'flex w-40 h-fit text-gray-300  px-1 py-2 my-2 text-2xl  mx-auto hover:opacity-75 max-md:ml-3' } >
        <p className='flex size-8 mr-2'>{params.svg}</p>
       <h1 className='text-xl'>{params.title}</h1>
      </Link>)
  }


  return (
    <div className=' w-52 bg-gray-900 shadow-lg justify-center align-middle max-md:w-14 ' style={{height:"94vh"}}>


      <Option href={'/'} title={'Dashboard'} svg={<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-home"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg>}/>
